...
export {GlobalObservableKey} from './other/global-observable-key';

export {useGlobalObservable} from './hooks/use-global-observable';
export {useSubscriberEffect} from './hooks/use-subscriber-effect';
export {useSubscriberSelector} from './hooks/use-subscriber-selector';
...
export {ISubscriber} from './types/i-subscriber';
export {IConfigurator} from "./types/i-configurator";
